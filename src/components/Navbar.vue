...
<template>
  <nav class="fixed top-0 left-1/2 mt-5 -translate-x-1/2 rounded-2xl md:w-[80%] w-[90%] z-50 bg-white/10 backdrop-blur-md text-white border border-white/20">
    <div class="mx-auto max-w-6xl px-4">
      <div class="flex h-16 items-center justify-between">
        <!-- Brand -->
        <h2 class="text-xl italic sm:text-xl font-bold">Devansh Khetan</h2>
