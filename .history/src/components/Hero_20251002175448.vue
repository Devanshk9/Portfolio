...
<template>
  ...
  <div class="flex flex-col items-center justify-center pt-[150px] pb-[100px] overflow-hidden text-white space-y-4">

    <div :class="mb-[100px]" v-for="(rail, i) in rails" :key="i" class="w-full overflow-hidden whitespace-nowrap">
      <!-- track -->
      <div
        class="track"
        v-for="n in 1"
