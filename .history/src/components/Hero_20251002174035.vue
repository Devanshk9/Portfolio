...
<template>
  ...
  <div class="flex flex-col items-center justify-center pt-[150px] pd-[100px] overflow-hidden text-white space-y-4">
    ...
    <h1 class=" mt-10 text-7xl font-bold mt-6">Hola, I am Devansh</h1>
