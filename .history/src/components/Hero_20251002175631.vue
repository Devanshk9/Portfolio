...
<template>
  ...
  <div class="flex flex-col items-center justify-center pt-[100px] pb-[100px] overflow-hidden text-white space-y-4">
    ...
    <h1 class=" mt-[1000px] text-7xl font-bold ">Hola, I am Devansh</h1>
